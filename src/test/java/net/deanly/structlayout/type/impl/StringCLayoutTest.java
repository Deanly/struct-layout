...
class StringCLayoutTest {

    @Test
    void testEncodeValidString() {
        StringCLayout layout = new StringCLayout();
    ...
    void testGetSpanValidData() {
        ...
        int span = layout.getSpan(dataWithNull, 0);
    ...
    void testGetSpanWithoutNullTerminator() {
        ...
        assertThrows(IllegalArgumentException.class, () -> layout.getSpan(data, 0)); // 널 종료 없는 경우 예외
    }
